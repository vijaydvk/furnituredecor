...
<head>
    ...
    <title>List of products | Furnituredecor</title>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php
									...
									try {	
										...
										if($true==1)
										{
										$sql = $conn->prepare("SELECT * FROM product where name='$search' or category='$search'");
										}
										else
										{
										...
										if($true==0)
							            $sql = $conn->prepare("SELECT * FROM product limit $start,$lim");
									    else
										{
										
										$sql = $conn->prepare("SELECT * FROM product where name='$search' or category ='$search' limit $start,$lim");
										}
										$sql->execute();
					...
					<?php
							            ...
							            echo '<ul class="pagination">';
                                            ...
                                            if($disp11==$ac)
                                               echo '<li><a href="allproducts.php?start='.$new.'" class="active">'.$disp11.'</a></li>';											
											else	
								            echo '<li><a href="allproducts.php?start='.$new.'">'.$disp11.'</a></li>';
											}
                   							echo '</ul>';
						                   echo '</div>';
